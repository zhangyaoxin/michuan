<template>
  <div>
    <p v-if="msTime.show">
      <div v-if="tipShow" style=" font-size: 18px;text-align: center;" class="no-bg">{{tipText}}</div>
      <div v-if="!tipShow" class="no-bg" style="font-size: 18px;text-align: center;">{{tipTextEnd}}</div>
      <div style="width: 218px;margin: 16px auto; text-align:center;">
        <span v-if="msTime.day>0" class="no-bg">
        <span class="tips">{{msTime.day}}</span>
        <i class="tip">{{dayTxt}}</i>
        </span>
        <span class="tips">{{msTime.hour}}</span><i class="tip">{{hourTxt}}</i>
        <span class="tips">{{msTime.minutes}}</span><i class="tip">{{minutesTxt}}</i>
        <span class="tips">{{msTime.seconds}}</span><i class="tip">{{secondsTxt}}</i>
      </div>
    </p>
